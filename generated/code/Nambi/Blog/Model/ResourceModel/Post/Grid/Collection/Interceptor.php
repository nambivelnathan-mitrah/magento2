<?php
namespace Nambi\Blog\Model\ResourceModel\Post\Grid\Collection;

/**
 * Interceptor class for @see \Nambi\Blog\Model\ResourceModel\Post\Grid\Collection
 */
class Interceptor extends \Nambi\Blog\Model\ResourceModel\Post\Grid\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\Data\Collection\EntityFactoryInterface $entityFactory, \Psr\Log\LoggerInterface $logger, \Magento\Framework\Data\Collection\Db\FetchStrategyInterface $fetchStrategy, \Magento\Framework\Event\ManagerInterface $eventManager, $mainTable = 'nambi_blog_post', $resourceModel = 'Nambi\\Blog\\Model\\ResourceModel\\Post')
    {
        $this->___init();
